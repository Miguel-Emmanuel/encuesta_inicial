        ...
        <div class="filtro">
            ...
            <div class="dropdown">
                <ul>
                    ...
                    <a
                        href="<?php echo "../filtros/index.php?id=" . $item['id'] . "&f=1" . "&nombre=" . urlencode($item['nombre']); ?>">
        ...
        <div class="filtro">
            ...
            <div class="dropdown">
                <ul>
                    ...
                    <a
                        href="<?php echo "../filtros/index.php?it=" . $tutor_id . "&ig=" . $grupoid . "&f=4" . "&nombre=" . urlencode($item['nomenclatura']); ?>">
        ...
        <div class="filtro">
            ...
            <div class="dropdown">
                <ul>
                    ...
                    <a
                        href="<?php echo "../filtros/index.php?id=" . $item['id'] . "&f=3" . "&nombre=" . urlencode($item['nombre']); ?>">
                        <li><?php echo htmlspecialchars($item['nombre']); ?></li>
                    </a>
                    <?php endforeach; ?>
                </ul>
