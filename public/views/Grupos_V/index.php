            ...
            <table class="table table-bordered table-hover">
                ...
                <?php foreach ($estudiantesGrupo as $est): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($est['grupo_academico']); ?></td>
                        <td><?php echo htmlspecialchars($est['tutor']); ?></td>
                        <td><?php echo htmlspecialchars($est['carrera']); ?></td>
                        <td>
                            <button class="btn btn-info ver-detalles" data-id="<?php echo $est['matricula']; ?>">Ver Detalles</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
