...
INSERT INTO preguntas (id, pregunta, tipo, seccion, activo, created_at, updated_at) VALUES
(1, 'Correo', 'texto', 'general', 1, NOW(), NOW()),
(2, 'Programa Educativo', 'select', 'general', 1, NOW(), NOW()),
(3, 'Nombre', 'texto', 'general', 1, NOW(), NOW()),
(4, 'Apellido Paterno', 'texto', 'general', 1, NOW(), NOW()),
(5, 'Apellido Materno', 'texto', 'general', 1, NOW(), NOW()),
(6, 'CURP', 'texto', 'general', 1, NOW(), NOW()),
(7, 'RFC', 'texto', 'contactar', 1, NOW(), NOW()),
(8, 'Sexo', 'texto', 'general', 1, NOW(), NOW()),
(9, 'Estado Civil', 'opcion', 'general', 1, NOW(), NOW()),
(10, 'Numero de Hijos', 'opcion', 'general', 1, NOW(), NOW()),
(11, 'Economicamente alguien depende de ti', 'texto', 'general', 1, NOW(), NOW()),
(12, 'Religión', 'texto', 'general', 1, NOW(), NOW()),
(13, 'Grupo Sanguíneo', 'texto', 'general', 1, NOW(), NOW()),
(14, 'Fecha de Nacimiento', 'texto', 'general', 1, NOW(), NOW()),
(15, 'Edad', 'texto', 'general', 1, NOW(), NOW()),
(16, 'País de Nacimiento', 'texto', 'general', 1, NOW(), NOW()),
(17, 'Estado de Nacimiento', 'texto', 'general', 1, NOW(), NOW()),
(18, 'Municipio de Nacimiento', 'texto', 'contactar', 1, NOW(), NOW()),
(19, 'Teléfono Celular', 'texto', 'contactar', 1, NOW(), NOW()),
(20, 'Teléfono Casa', 'texto', 'contactar', 1, NOW(), NOW()),
(21, 'Correo Electrónico Personal', 'texto', 'contactar', 1, NOW(), NOW()),
(22, 'Redes Sociales', 'texto', 'contactar', 1, NOW(), NOW()),
(23, 'Calle', 'texto', 'contactar', 1, NOW(), NOW()),
(24, 'No. Exterior', 'texto', 'contactar', 1, NOW(), NOW()),
(25, 'No. Interior', 'texto', 'contactar', 1, NOW(), NOW()),
(26, 'Colonia', 'texto', 'contactar', 1, NOW(), NOW()),
(27, 'Localidad', 'texto', 'contactar', 1, NOW(), NOW()),
(28, 'Municipio', 'texto', 'contactar', 1, NOW(), NOW()),
(29, 'CP', 'texto', 'contactar', 1, NOW(), NOW()),
(30, 'Menciona 2 referencias cerca de su domicilio', 'texto', 'contactar', 1, NOW(), NOW()),
(31, 'Nombre', 'texto', 'emergencia', 1, NOW(), NOW()),
(32, 'Apellido Paterno', 'texto', 'emergencia', 1, NOW(), NOW()),
(33, 'Apellido Materno', 'texto', 'emergencia', 1, NOW(), NOW()),
(34, 'Parentesco', 'multi', 'emergencia', 1, NOW(), NOW()),
(35, 'Correo Electronico', 'texto', 'emergencia', 1, NOW(), NOW()),
(36, 'Telefono Celular', 'texto', 'emergencia', 1, NOW(), NOW()),
(37, 'Telefono de casa', 'texto', 'emergencia', 1, NOW(), NOW()),
(38, 'Domicilio Completo', 'texto', 'emergencia', 1, NOW(), NOW()),
(39, 'Menciona dos referencias cerca de su domicilio', 'texto', 'emergencia', 1, NOW(), NOW()),
(40, 'Nombre', 'texto', 'emergencia', 1, NOW(), NOW()),
(41, 'Apellido Paterno', 'texto', 'emergencia', 1, NOW(), NOW()),
(42, 'Apellido Materno', 'texto', 'emergencia', 1, NOW(), NOW()),
(43, 'Parentesco', 'multi', 'emergencia', 1, NOW(), NOW()),
(44, 'Correo Electronico', 'texto', 'emergencia', 1, NOW(), NOW()),
(45, 'Telefono Celular', 'texto', 'emergencia', 1, NOW(), NOW()),
(46, 'Telefono casa', 'texto', 'emergencia', 1, NOW(), NOW()),
(47, 'Domicilio', 'texto', 'emergencia', 1, NOW(), NOW()),
(48, 'Menciona 2 referencias cerca de su domicilio', 'texto', 'emergencia', 1, NOW(), NOW()),
(49, 'Trabajas', 'opcion', 'socioeconomicos', 1, NOW(), NOW()),
(50, 'Cuantas horas trabajas a la semana', 'opcion', 'socioeconomicos', 1, NOW(), NOW()),
(51, 'Lugar de trabajo', 'texto', 'socioeconomicos', 1, NOW(), NOW()),
(52, 'Domicilio del lugar de trabajo', 'texto', 'socioeconomicos', 1, NOW(), NOW()),
(53, 'Dias de trabajo', 'multi', 'socioeconomicos', 1, NOW(), NOW()),
(54, 'Horarios de trabajo', 'texto', 'socioeconomicos', 1, NOW(), NOW()),
(55, 'Ingreso mensual', 'texto', 'socioeconomicos', 1, NOW(), NOW()),
(56, 'De quien dependes economicamente', 'opcion', 'socioeconomicos', 1, NOW(), NOW()),
(57, 'Con quien vives actualmente', 'multi', 'socioeconomicos', 1, NOW(), NOW()),
(58, 'Aporta al gasto familiar', 'multi', 'socioeconomicos', 1, NOW(), NOW()),
(59, 'Ingreso mensual de todos los integrantes de la familia', 'texto', 'socioeconomicos', 1, NOW(), NOW()),
(60, 'Edad de los integrantes de la familia', 'multi', 'socioeconomicos', 1, NOW(), NOW()),
(61, 'Ocupacion del quien aporta la mayor parte del gasto familiar', 'texto', 'socioeconomico', 1, NOW(), NOW()),
(62, 'Cual es tu lugar de residencia mientras estudias la carrera', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(63, 'Tiempo de residencia en el domicilio', 'texto', 'socioeconomico', 1, NOW(), NOW()),
(64, 'En la casa donde vives hay', 'multi', 'socioeconomico', 1, NOW(), NOW()),
(65, 'Cual es el medio de transporte que utilizas regularmente para trasladarte a la escuela', 'multi', 'socioeconomico', 1, NOW(), NOW()),
(66, 'Cuanto tiempo haces diariamente para trasladarte de tu lugar de residencia a la escuela', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(67, 'Analisis relacion Padre', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(68, 'Analisis relacion Madre', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(69, 'Tus papas o tus abuelos son indigenas', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(70, 'Tus papas o tus abuelos entienden o hablan alguna lengua indigena', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(71, 'Tu hablas o entiendes alguna lengua indigena', 'opcion', 'socioeconomico', 1, NOW(), NOW()),
(72, 'Indica si presentas alguna de las siguientes condiciones', 'multi', 'Condiciones de salud', 1, NOW(), NOW()),
(73, 'Tiene algun padecimiento cronico', 'opcion', 'Condiciones de salud', 1, NOW(), NOW()),
(74, 'Nombre del padecimiento cronico', 'texto', 'Condiciones de salud', 1, NOW(), NOW()),
(75, 'Tiene alguna alergia', 'opcion', 'Condiciones de salud', 1, NOW(), NOW()),
(76, 'Nombre de la alergia', 'texto', 'Condiciones de salud', 1, '2024-06-02 23:39:06', '2024-06-02 23:39:06'),
(77, '¿Tomas algún medicamento periódicamente?', 'opcion', 'Condiciones de salud', 1, '2024-06-02 23:39:06', '2024-06-02 23:39:06'),
(78, 'Nombre del medicamento', 'texto', 'Condiciones de salud', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(79, '¿Has recibido atención psicológica o psiquiátrica?', 'opcion', 'Condiciones de salud', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(80, 'Motivo de la atención psicológica o psiquiátrica', 'texto', 'Condiciones de salud', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(81, '¿Ha estado alguna vez hospitalizado(a)?', 'opcion', 'Condiciones de salud', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(82, 'Especifica el motivo de la hospitalización', 'texto', 'Condiciones de salud', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(83, '¿En qué tipo de escuela realizaste tus estudios previos a la educación superior?', 'opcion', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(84, '¿En qué tipo de escuela realizaste tus estudios previos a la educación superior?', 'opcion', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(85, 'Nombre de la institución de nivel medio superior', 'texto', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(86, 'Especialidad que cursó en el nivel medio superior', 'texto', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(87, 'Municipio donde se ubica la institución de nivel medio superior', 'texto', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(88, 'Estado donde se ubica la institución de nivel medio superior', 'texto', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(89, '¿Cuál fue la escolaridad máxima alcanzada por tu madre?', 'multi', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(90, '¿Cuál fue la escolaridad máxima alcanzada por tu padre?', 'multi', 'Rendimiento escolar', 1, '2024-06-02 23:41:14', '2024-06-02 23:41:14'),
(91, '¿Tienes hermanos que estén cursando una carrera de licenciatura?', 'opcion', 'Rendimiento escolar', 1, '2024-06-02 00:39:49', '2024-06-02 00:39:49'),
(92, 'En el proceso para que decidieras cursar tu carrera, ¿qué factores fueron de mayor importancia?', 'multi', 'Rendimiento escolar', 1, '2024-06-03 00:39:49', '2024-06-03 00:39:49'),
(93, '¿Cursas alguna otra carrera actualmente?', 'opcion', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(94, 'Nombre de la otra carrera que cursas actualmente', 'texto', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(95, 'Nombre de la institución de la otra carrera que cursas actualmente', 'texto', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(96, '¿Cursaste otra carrera antes de entrar a la UTVT?', 'opcion', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(97, '¿La carrera que cursaste anteriormente es la misma con la que iniciaste tus estudios?', 'opcion', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(98, 'Nombre de la institución de la carrera que cursaste antes de entrar a la UTVT', 'texto', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(99, '¿A qué factores se debió tu cambio de carrera?', 'multi', 'Rendimiento escolar', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(100, '¿Qué tipo de lecturas acostumbras a utilizar al cursar tus estudios?', 'multi', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(101, 'En promedio, ¿Cuántas horas dedicas a la semana a la preparación de tus trabajos? (comprende lecturas y preparación de trabajos y tareas)', 'opcion', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:52:10', '2024-06-03 00:52:10'),
(102, '¿Cuáles son las formas de estudio y/o realización de trabajos escolares que empleas regularmente?', 'multi', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:39:49', '2024-06-03 00:39:49'),
(103, 'De acuerdo con la carrera que cursas actualmente, ¿en qué espacio laboral pretenderías preferentemente desarrollar tu actividad profesional?', 'opcion', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(104, 'Una vez concluidos tus estudios, ¿cómo consideras tus posibilidades de encontrar trabajo relacionado con tu profesión?', 'opcion', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(105, 'En comparación con la ocupación de tu padre o de la persona que ocupa el lugar de jefe de familia, ¿cómo percibes el desarrollo de tu vida profesional una vez que concluyas tus estudios de licenciatura?', 'multi', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03'),
(106, '¿Dentro de tus planes futuros piensas realizar estudios de posgrado después de concluir tu carrera?', 'opcion', 'Hábitos de estudio y prácticas escolares', 1, '2024-06-03 00:43:03', '2024-06-03 00:43:03');
