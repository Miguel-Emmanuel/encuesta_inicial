    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" action="../../../app/Grupos/actualiza.php" method="post" enctype="multipart/form-data">
                ...
                <div class="md-3">
                    ...
                    <div class="md-3">
                        <label for="validationCustom04" class="form-label">Periodo educativo</label>
