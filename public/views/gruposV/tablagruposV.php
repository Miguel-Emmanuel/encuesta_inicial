...
$sqlGrupos = "SELECT id, nombregv, descripcion FROM gruposv";
...
<div class="container py-3">
    <h2 class="text-center">Grupos V</h2>
...
<script>
    ...
    nuevomodal.addEventListener('hide.bs.modal', event => {
        nuevomodal.querySelector('.modal-body #nombregv').value = ""
        nuevomodal.querySelector('.modal-body #descripcion').value = ""
    })

    editarmodal.addEventListener('hide.bs.modal', event => {
        editarmodal.querySelector('.modal-body #nombregv').value = ""
    ...
    editarmodal.addEventListener('shown.bs.modal', event => {
        ...
        let inputNombregv = editarmodal.querySelector('.modal-body #nombregv')
        let inputDes = editarmodal.querySelector('.modal-body #descripcion')

        let url = "../../../app/Controllers/GruposV/getGruposV.php"
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                inputNombregv.value = data.nombregv
