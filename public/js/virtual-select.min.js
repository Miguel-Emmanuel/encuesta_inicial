                ...
                (o = [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            h.setAttrFromEle(t, n, Object.keys(x), k),
                ...
                (i = [
                    {
                        ...
                        value: function () {
                            if (this.$ele) {
                                ...
                                var r = '<div id="vscomp-ele-wrapper-'
                    ...
                    },
                    {
                        ...
                        value: function () {
                            h.addClass(this.$ele, "vscomp-ele"),
                                this.renderSearch(),
                                this.setEleStyles(),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var m = function e(s) {
                                ...
                                if (
                                    (g || "" !== O || (g = !0),
                                    i && (w.isDisabled = !0 === b[O]),
                                    s.isGroupOption &&
                                        ((w.isGroupOption = !0),
                                        (w.groupIndex = s.groupIndex)),
                                    l && (w.description = h(u(s[r]))),
                                    s.customData &&
                                        (w.customData = s.customData),
                                    t.push(w),
                                    (d += 1),
                                    x)
                                ) {
                            ...
                            (S.options = t),
                                (S.length = O),
                                (this.options = t),
                                (this.visibleOptionsCount = O),
                                (this.lastOptionIndex = O - 1),
                                (this.newValues = []),
                                (this.hasOptionGroup = y),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            (this.$ele.value = l),
                                ...
                                r || this.validate(),
                                o || h.dispatchEvent(this.$ele, "change", !0);
                        },
                    },
                    {
                        key: "setValueText",
                        value: function () {
                            ...
                            if (u && this.hideValueTooltipOnSelectAll)
                                ...
                                var c = n.join(", ");
                                if ("" === c) s.innerHTML = this.placeholder;
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.hasOptionGroup &&
                                (e = this.getVisibleOptionGroupsMapping(o)),
                        ...
                        value: function (e) {
                            ...
                            e
                                ...
                                : ((t = this.optionsHeight),
                                  this.keepAlwaysOpen &&
                                      (h.setStyle(this.$noOptions, "height", t),
                                      h.setStyle(
                                          this.$noSearchResults,
                                          "height",
                                          t
                        ...
                        value: function () {
                            ...
                            e &&
                                (this.showAsPopup
                                    ? (t["max-width"] = e)
                                    : (i.width = e)),
                                h.setStyles(this.$dropboxContainer, i),
                                h.setStyles(this.$dropbox, t);
                        },
                    },
                    {
                        key: "setOptionAttr",
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            do {
                                ...
                                h.hasClass(o, "disabled") ||
                                h.hasClass(o, "group-title")
                            );
                            return o;
                        },
                    },
                        ...
                        value: function (e) {
                            (this.isSilentOpen = e),
                                e
                                    ...
                                    : (h.dispatchEvent(this.$ele, "beforeOpen"),
                                      h.setAria(this.$wrapper, "expanded", !0)),
                                this.setDropboxWrapperWidth(),
                                h.removeClass(this.$allWrappers, "closed"),
                        ...
                        value: function () {
                            ...
                            (this.isSilentOpen = !1),
                                e ||
                                    ...
                                    this.setScrollTop(),
                                    h.addClass(this.$allWrappers, "focused"),
                                    this.showAsPopup
                                        ? (h.addClass(
                                              this.$body,
                                              "vscomp-popup-active"
                                    ...
                                    h.dispatchEvent(this.$ele, "afterOpen"));
                        },
                    },
                    {
                        key: "closeDropbox",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.isSilentClose = !1),
                                h.removeClass(this.$allWrappers, "focused"),
                                this.removeOptionFocus(),
                                !e &&
                                    this.isPopupActive &&
                                    (h.removeClass(
                                ...
                                h.addClass(this.$allWrappers, "closed"),
                                e || h.dispatchEvent(this.$ele, "afterClose");
                        },
                    },
                    {
                    ...
                    },
                    {
                        key: "isOpened",
                        value: function () {
                            return !h.hasClass(this.$wrapper, "closed");
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (o) e = o;
                                ...
                                (e = this.$dropboxContainer.querySelector(
                                    ...
                                    (h.hasClass(e, "disabled") ||
                                        h.hasClass(e, "group-title")) &&
                        ...
                        value: function (e) {
                            ...
                            if (e) {
                                ...
                                var n = this.selectedValues,
                                    r = h.getData(e, "value"),
                                    a = h.getData(e, "index", "number"),
                                    l = h.hasClass(e, "current-new"),
                                    u = !1,
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (
                                ...
                                var o = h.getData(e, "index", "number"),
                                    n = this.selectedValues,
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            if (e) {
                                var i = h.getData(e, "index", "number");
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.options.forEach(function (e) {
                                ...
                                h.dispatchEvent(this.$ele, "reset");
                        },
                    },
                    {
                        key: "addOption",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                !t.isGroupTitle || (n && h) || (h = s[t.index]),
                                r || !p || h || (h = -1 !== p.indexOf(i)),
                                r ||
                                    !u ||
                                    h ||
                                    (h = -1 !== u.toLowerCase().indexOf(i)),
                                (t.isVisible = h),
                                o || (o = l === i || a === i),
                                { isVisible: h, hasExactOption: o }
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this.$ele.disabled = !1),
                                ...
                                h.setAria(this.$wrapper, "disabled", !1);
                        },
                    },
                    {
                        key: "disable",
                        value: function () {
                            (this.$ele.disabled = !0),
                                ...
                                h.setAria(this.$wrapper, "disabled", !0);
                        },
                    },
                    {
                        key: "validate",
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var i = t;
                            void 0 === i && (i = !h.hasClass(e, "selected")),
                                h.toggleClass(e, "selected", i),
                                h.setAria(e, "selected", i);
                        },
                    },
                    {
