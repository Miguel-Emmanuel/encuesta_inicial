...
CREATE TABLE `estudiante_grupo` (
  ...
  CONSTRAINT `estudiante_grupo_ibfk_4` FOREIGN KEY (`tutor_id`) REFERENCES `tutores` (`id`) ON DELETE NO ACTION
...
CREATE TABLE `estudiantes` (
  ...
  `grupos_v` int(11) DEFAULT NULL,
  `i_genero` int(11) DEFAULT 1,
  `activo` int(11) DEFAULT 1,
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  KEY `i_genero` (`i_genero`),
  KEY `grupos_v` (`genero`),
  CONSTRAINT `estudiantes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION,
  CONSTRAINT `estudiantes_ibfk_2` FOREIGN KEY (`i_genero`) REFERENCES `i_genero` (`id`) ON DELETE NO ACTION,
  CONSTRAINT `estudiantes_ibfk_3` FOREIGN KEY (`genero`) REFERENCES `gruposv` (`id`) ON DELETE NO ACTION
